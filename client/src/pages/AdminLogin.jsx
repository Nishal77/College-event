...
export default function AdminLogin() {
  ...
  return (
    <div className="flex w-full min-h-screen px-10 py-10 justify-center items-center bg-background">
      <div className="bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl shadow-lg">
        <form className="flex flex-col w-auto items-center" onSubmit={handleAdminLogin}>
          <div className="mb-6">
          ...
          <h1 className="px-3 font-extrabold mb-2 text-primarydark text-3xl">Admin Panel</h1>
          <p className="text-gray-600 mb-6 text-sm">Sign in to access admin dashboard</p>
